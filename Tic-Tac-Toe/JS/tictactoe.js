//This variable keeps track of the active player. 
let activePlayer = 'X';
//The array declared below is an array of moves used to determine win conditions.
let selectedSquares = [];

//This function places the "X" and "O" avatars during gameplay.
function placeXorO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the image is placed in html.
            select.style.backgroundImage = 'url("./Images/X.png")';
        //Active player may only be 'X' or 'O' so, if not 'X'it must be 'O'.
        } else {
            //If activePlayer is equal to 'O', the image is placed in html.
        ...
        //This function plays placememnt sound.
        audio('./Media/place.wav');
        //This condition checks to see if it is computers turn.
        if (activePlayer === 'O') {
            //This functions disables clicking for computer choice
            disableClick();
            //This function waits 1 second before placing the image and emabling click.
...
//drawWinLine function is called to draw line condition is met.
function checkWinConditions() {
    ...
    //This function checks if an array inclues 3 strings. It is used to check for each win condition.
...
//This function takes a string parameter of the path you set earlier for the place.mp3 sound.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line provides access to methods and properties to use on the canvas element
    ...
    let x1 = coordX1,
        ...
        y2 = coordY2,
        //These variables store temporary x and y axis data updated in the animation loop.
        x = x1,
        y = y1;
    //This function interacts with the canvas.
    function animateLineDrawing() {
        //This variable creates the loop for when the game restarts after ending.
        ...
        c.stroke();
        //This condition checks if the line has reached its endpoint.
        if (x1 <= x2 && y1 <= y2) {
        ...
        //This condition is similar to the previous but was necessary for the 6, 4, 2 win condition.
        if (x1 <= x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10; }
            if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
    ...
    function clear() {
        ...
        c.clearRect (0, 0, 608, 608);
        //This line stopr our animation loop.
        cancelAnimationFrame(animationLoop);
    }
    //This line disallaows clicking while the win sound is playing.
    disableClick();
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        //This removes the image from the square.
